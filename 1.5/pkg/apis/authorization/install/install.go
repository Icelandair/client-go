...
import (
	...
	"github.com/Icelandair/client-go/1.5/pkg/apis/authorization"
	"github.com/Icelandair/client-go/1.5/pkg/apis/authorization/v1beta1"
...
func init() {
	if err := announced.NewGroupMetaFactory(
		&announced.GroupMetaFactoryArgs{
			...
			ImportPrefix:               "github.com/Icelandair/client-go/1.5/pkg/apis/authorization",
